...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-skills': { kind: 'indirect', reason: 'Browser-side settings surface; the skill registry it writes overrides for owns every model-facing catalog and body.' },
