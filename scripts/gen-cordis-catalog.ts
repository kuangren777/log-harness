...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  sciAudit: 'sci.md',
  sciMemory: 'sci.md',
  sciLiterature: 'sci.md',
  sciLibrary: 'sci.md',
  sciCitations: 'sci.md',
  sciAgents: 'sci.md',
  sciRemoteHosts: 'sci.md',
  sciTierFork: 'sci.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  dshBundlePath: 'not a service: launcher-provided root accessor function (BundlePathResolver | undefined) resolving a path inside a profile bundle for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
  ...
  univer: 'vendored Univer office runtime service (dsh-univer-office fork); no subsystems page — packages/office/univer/README.md owns the API',
  ...
  sciFiles: 'client-side interface-typed browser service — packages/client/ui-sci-files/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ReferencedTextRef: 'content-addressed text reference is owned by packages/attachment/referenced-text/README.md',
  ReferencedTextStore: 'referenced-text store contract is owned by packages/attachment/referenced-text/README.md',
  ReferencedTextBlock: 'referenced-text content block is owned by packages/attachment/referenced-text/README.md',
  RebuildReport: 'science-research product-layer contract is owned by packages/sci/sci-audit/README.md',
  AuditSummary: 'science-research product-layer contract is owned by packages/sci/sci-audit/README.md',
  AuditRecord: 'science-research product-layer contract is owned by packages/sci/sci-audit/README.md',
  DeliveryRecord: 'science-research product-layer contract is owned by packages/sci/sci-audit/README.md',
  PlanRecord: 'science-research product-layer contract is owned by packages/sci/sci-audit/README.md',
  RecallIndexValue: 'science-research product-layer contract is owned by packages/sci/sci-memory/README.md',
  RecallSessionRequest: 'science-research product-layer contract is owned by packages/sci/sci-memory/README.md',
  RecallSessionResult: 'science-research product-layer contract is owned by packages/sci/sci-memory/README.md',
  MemoryIndexRecord: 'science-research product-layer contract is owned by packages/sci/sci-memory/README.md',
  LiteratureSearchRequest: 'science-research product-layer contract is owned by packages/sci/sci-literature/README.md',
  LiteratureSearchResult: 'science-research product-layer contract is owned by packages/sci/sci-literature/README.md',
  LiteratureRecord: 'science-research product-layer contract is owned by packages/sci/sci-literature/README.md',
  LiteratureRecentResult: 'science-research product-layer contract is owned by packages/sci/sci-literature/README.md',
  LiteratureForgetRequest: 'science-research product-layer contract is owned by packages/sci/sci-literature/README.md',
  LiteratureForgetResult: 'science-research product-layer contract is owned by packages/sci/sci-literature/README.md',
  LiteratureSourceError: 'science-research product-layer contract is owned by packages/sci/sci-literature/README.md',
  LiteratureHistoryEntry: 'science-research product-layer contract is owned by packages/sci/sci-literature/README.md',
  LibraryKind: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryStatus: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibrarySource: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryFile: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryEntry: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryQuery: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryPage: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryGetRequest: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryGetResult: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryAddRequest: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryAddResult: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryPatch: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryUpdateRequest: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryUpdateResult: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryRemoveRequest: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryRemoveResult: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryRelatedRequest: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryRelatedResult: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryFetchPdfRequest: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  LibraryFetchPdfResult: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  UploadedFile: 'science-research product-layer contract is owned by packages/sci/sci-library/README.md',
  CitationGroup: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  Citation: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationPool: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationsProjectsResult: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationPoolRequest: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationGroupUpsertRequest: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationGroupRemoveRequest: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationMoveRequest: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationAddRequest: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationAddResult: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationUpdateRequest: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationRemoveRequest: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationOkResult: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationRescanRequest: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationExportRequest: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationExportResult: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  BibEntry: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  ParseError: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationProjectsResult: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  CitationRescanResult: 'science-research product-layer contract is owned by packages/sci/sci-citations/README.md',
  AgentModelRef: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  AgentPermissions: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  AgentStats: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  RosterAgent: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  AgentCallStatus: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  AgentCall: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  ModelOption: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  ModelProvider: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  AgentPatch: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  ConfigureRequest: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  CallsRequest: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  RosterResult: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  ConfigureResult: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  CallsResult: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  ModelsResult: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  ModelCatalogFailure: 'science-research product-layer contract is owned by packages/sci/sci-agents/README.md',
  HostsListValue: 'science-research product-layer contract is owned by packages/sci/sci-remote-hosts/README.md',
  HostsResult: 'science-research product-layer contract is owned by packages/sci/sci-remote-hosts/README.md',
  UpsertHostRequest: 'science-research product-layer contract is owned by packages/sci/sci-remote-hosts/README.md',
  RemoveHostRequest: 'science-research product-layer contract is owned by packages/sci/sci-remote-hosts/README.md',
  ToggleHostRequest: 'science-research product-layer contract is owned by packages/sci/sci-remote-hosts/README.md',
  SciTierForkRequest: 'science-research product-layer contract is owned by packages/sci/sci-tier/README.md',
  SciTierForkResult: 'science-research product-layer contract is owned by packages/sci/sci-tier/README.md',
