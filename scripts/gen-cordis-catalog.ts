...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  Principal: 'the caller identity is owned by packages/auth/auth/README.md',
  PermissionRule: 'the permission vocabulary is owned by packages/auth/auth/README.md',
  UserId: 'branded account id is owned by packages/auth/auth/README.md',
  GroupId: 'branded permission-group id is owned by packages/auth/auth/README.md',
  AuthSessionId: 'branded login-session id is owned by packages/auth/auth/README.md',
  OneTimeTokenId: 'branded one-time-secret id is owned by packages/auth/auth/README.md',
  OneTimeTokenKind: 'one-time-secret kinds are owned by packages/auth/auth/README.md',
  UserRecord: 'stored account record is owned by packages/auth/auth/README.md',
  GroupRecord: 'stored group record is owned by packages/auth/auth/README.md',
  LoginOutcome: 'login verification result is owned by packages/auth/auth/README.md',
  AuthSessionMeta: 'login-session provenance is owned by packages/auth/auth/README.md',
  IssuedAuthSession: 'issued login session is owned by packages/auth/auth/README.md',
  IssuedOneTimeToken: 'issued one-time secret is owned by packages/auth/auth/README.md',
  AuditEntry: 'audit append record is owned by packages/auth/auth/README.md',
  AuditRecord: 'stored audit row is owned by packages/auth/auth/README.md',
  MailMessage: 'the outbound message record is owned by packages/mail/mail/README.md',
  RequestHeaders: 'the two HTTP header representations are owned by packages/host/apiproxy/src/authorization.ts',
