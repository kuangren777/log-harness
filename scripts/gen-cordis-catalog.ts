...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  Principal: 'auth.md',
  PermissionDomain: 'auth.md',
  PermissionRule: 'auth.md',
  UserId: 'auth.md',
  GroupId: 'auth.md',
  AuthSessionId: 'auth.md',
  OneTimeTokenId: 'auth.md',
  OneTimeTokenKind: 'auth.md',
  UserRecord: 'auth.md',
  GroupRecord: 'auth.md',
  LoginOutcome: 'auth.md',
  AuthSessionMeta: 'auth.md',
  IssuedAuthSession: 'auth.md',
  IssuedOneTimeToken: 'auth.md',
  AuditEntry: 'auth.md',
  AuditRecord: 'auth.md',
  RequestHeaders: 'auth.md',
  MailMessage: 'mail.md',
