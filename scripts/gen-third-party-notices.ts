...
/**
 * SPDX identifiers this project may ship without further review. `MIT-0` is
 * MIT without its attribution clause, so it imposes a strict subset of the
 * obligations `MIT` already carries here ([review](../.agents/notes/implemented/architecture/2026-08-23-mail-capability-seam.md)).
 */
