 ...
 * @param value - the provider's operation result.
 * @returns the text the model reads for that result.
 */
 ...
 * @param operation - the operation name shown to the user.
 * @param file - the file the operation targets.
 ...
 * @returns the same tool, with `UniverError` failures rendered as `Error [CODE]: message`.
 */
