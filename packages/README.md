...
| [`auth/`](auth/README.md) | Login, request gate, and permission-group seam; SQLite credential store | Product — stable API |
| [`mail/`](mail/README.md) | Outbound-mail seam; SMTP and JSON-line file providers | Product — stable API |
