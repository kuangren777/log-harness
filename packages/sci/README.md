...
| [`sci-tier/`](sci-tier/README.md) | The two tiers, shown as `单体 / Solo` and `蜂群 / Swarm`: tier section, fan-out guard, declare-before-fan-out latch, upgrade suggestion, fork RPC. | `ctx.tools.guard`, `tools/pre-execute`, RPC |
