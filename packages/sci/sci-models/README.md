...
- **Prices are read by other consumers, not here.** A deployment whose gate serves a catalog but no rate card gets correct enforcement and the built-in official prices from `dsh-sci-credit`; nothing in this package notices the disagreement.
