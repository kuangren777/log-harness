...
export const zh = {
  ...
  'preview.pdfRendering': '正在渲染 PDF…',
  'preview.pdfFailed': '这份 PDF 无法解析。',
  'preview.pdfPages': '共 {count} 页',
  'preview.pdfMore': '继续渲染剩余 {count} 页',
  'preview.officeConvert': '这个 Office 文档要先转换成 .univer 才能在线打开：让智能体对它运行 univer_import，或点右上角下载原文件。',
...
export const en: Record<SciFilesKey, string> = {
  ...
  'preview.pdfRendering': 'Rendering the PDF…',
  'preview.pdfFailed': 'This PDF could not be parsed.',
  'preview.pdfPages': '{count} pages',
  'preview.pdfMore': 'Render the remaining {count} pages',
  'preview.officeConvert': 'This Office document opens online only after conversion to .univer: ask the agent to run univer_import on it, or download the original from the header.',
