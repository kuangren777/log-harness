...
import {
  ArrowUp, IconPlusOutline16, IconWarningOutline16, MorphStrokeIcon, Square, StrokeIcon, Toast, Tooltip,
          ...
          <div className={css.trailing}>
            ...
            {interruptible && (
              <Tooltip label={t('input.stop')} side="top" delayMs={500}>
                <button
                  ...
                  onClick={stop}
                >
                  <StrokeIcon icon={Square} size={16} />
                </button>
              </Tooltip>
            )}
            <Tooltip label={primaryLabel} side="top" delayMs={500}>
              <button
                ...
                onClick={onPrimary}
              >
                <MorphStrokeIcon icon={primaryStops ? Square : ArrowUp} size={16} />
              </button>
            </Tooltip>
          </div>
        </div>
