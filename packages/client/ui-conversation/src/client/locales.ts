...
export const zh = {
  ...
  'fileOpen.copied': '此部署无法打开本机文件，已复制路径：{path}',
  'fileOpen.copyFailed': '此部署无法打开本机文件，复制路径也失败了：{path}',
...
export const en = {
  ...
  'fileOpen.copied': 'This deployment can’t open local files; path copied: {path}',
  'fileOpen.copyFailed': 'This deployment can’t open local files, and copying the path failed: {path}',
