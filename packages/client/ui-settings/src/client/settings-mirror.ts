...
export interface SettingsMirrorSnapshot {
  /**
   * `unavailable` is the terminal state of a memory-plane page; `ready` persists across
...
export class SettingsDescribeMirror implements SettingsDescribeFace {
   ...
   * @param persistence - the connection's configuration plane; a page the settings RPCs refuse stays process-local.
   */
  constructor(
