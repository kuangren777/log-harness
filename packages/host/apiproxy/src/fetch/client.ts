...
export interface IApiClient {
  ...
  skills: {
    ...
    inventory(payload: RequestPayload<'skill.inventory'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'skill.inventory'>>>
  }
  agentPresets: {
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'skill.inventory': skillInventoryValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly skills: IApiClient['skills'] = {
    ...
    inventory: (payload, signal) => this.callUnary('skill.inventory', payload, signal),
  }
