...
export interface ApiProxy {
  ...
  llm: LlmApi
  /** Administration plane of the auth seam; every row is an `admin` policy. */
...
export type { AdminGroupView, AdminRuleView, AdminUserView, AuthAdminApi } from './auth-admin.ts'
