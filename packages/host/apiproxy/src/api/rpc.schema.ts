...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('path-out-of-scope'), message: z.string(), details: z.object({ path: z.string(), cwd: z.string() }) }),
  z.object({ code: z.literal('file-not-found'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('not-a-file'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('file-too-large'), message: z.string(), details: z.object({ path: z.string(), maxBytes: z.number() }) }),
  z.object({ code: z.literal('not-a-directory'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('too-many-entries'), message: z.string(), details: z.object({ path: z.string(), maxEntries: z.number() }) }),
