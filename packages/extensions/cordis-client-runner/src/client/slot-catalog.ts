...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      'client-ui-conversation DetailsToolMode',
      'client-ui-sci-files FilesMode',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.details.mode\', () => ctx.slots.register(\n      { name: \'conversation.details.mode\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'conversation.details.mode\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sci-files SciToolDetails',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-brand-sci SciBrandMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'office-univer UniverDock id \'univer-dock\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Bottom-aligned rail controls (palette, account).',
    doc: 'Bottom-aligned rail controls (palette, account). Same owner share as\n`rail.item`: a footer control that also routes a view can.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [
      'client-ui-sci-shell ThemeToggle id \'theme-toggle\'',
      'client-ui-sci-shell ProfileButton id \'profile\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'rail.footer\', () => ctx.slots.register(\n      { name: \'rail.footer\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-sci-shell/src/client/index.ts:45',
  },
  {
    key: 'rail.item',
    kind: 'list',
    scope: 'root',
    summary: 'View buttons of the icon rail, top-aligned in registration order.',
    doc: 'View buttons of the icon rail, top-aligned in registration order.\nDeclared by this package\'s rail occupant; every entry receives the\nframe\'s view state, so a button renders its own pressed state and\nswitches views without reaching for `ctx.layout`.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'rail.item\', () => ctx.slots.register(\n      { name: \'rail.item\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-sci-shell/src/client/index.ts:40',
  },
  {
    key: 'root',
    kind: 'single',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sci-shell Aurora id \'sci-aurora\'',
      'client-ui-sci-shell ProfilePopover id \'sci-profile\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-brand-sci SciBrandName',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'view\', () => ctx.slots.register(\n      { name: \'view\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
