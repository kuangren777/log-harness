...
来源：[`packages/auth/auth-gate/src/settings.ts:16`](../packages/auth/auth-gate/src/settings.ts)
...
来源：[`packages/skill/skill/src/index.ts:291`](../packages/skill/skill/src/index.ts)
...
- `@deepseek-ai/dsh-client-ui-settings-access`（[`packages/client/ui-settings-access/src/index.ts`](../packages/client/ui-settings-access/src/index.ts)）
