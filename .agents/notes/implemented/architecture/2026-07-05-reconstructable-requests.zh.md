...
- referenced-text store 可声明 `mode: 'live'`，这是对字节精确重建的一处限定例外：解析跟随 store 当前文本，日志摘要只记录出处；该决定由 [live referenced-text store](2026-08-31-live-referenced-text-stores.zh.md) 拥有。
